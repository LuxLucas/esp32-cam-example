...
#define CONFIG_LED_MAX_INTENSITY 127
...
void setupLedFlash() {
    ...
    // Sintaxe para o Core v3.x (IDE do Arduino recente)
    ledcAttach(LED_GPIO_NUM, 5000, 8);
  #else
    // Sintaxe para o Core v2.x (PlatformIO padrão)
    ledcSetup(LEDC_CHANNEL_0, 5000, 8);
    ledcAttachPin(LED_GPIO_NUM, LEDC_CHANNEL_0);
